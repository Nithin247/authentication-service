...
public class HibernateDao<T, ID extends Serializable> implements Dao<T, ID> {
	...
	@Override
	public List<T> findAllBy(String property, List<?> values, Object order) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<T> findAllBy(String property, Object value, Object order) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<T> findAll(Object order) {
		// TODO Auto-generated method stub
		return null;
	}
}
